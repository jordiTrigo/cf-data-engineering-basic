...
#%%
# Necesitaremos realizar una geocodificación para cada ciudad, ya que el endpoint de la API de OpenWeather 
# necesita coordenadas las geográficas de latitud y longitud. Para ello, utilizaremos el geocodificador 
...
df_coordenadas = df.apply(lambda x: obtener_coordenadas(x.city, x.country), axis=1)
...
# Para ello convertiremos el DataFrame de pandas en un GeoDataFrame y crearemos una columna 
# con coordenadas. Se establecerá el CRS en 4326, que define el sistema de coordenadas como 
# WGS84 — World Geodetic System 1984, que utiliza latitud y longitud en grados (unidad).
